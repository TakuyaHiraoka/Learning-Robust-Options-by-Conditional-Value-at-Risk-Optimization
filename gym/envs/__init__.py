...
register(
    id='HalfCheetah-Random-Params-v1',
    entry_point='gym.envs.mujoco:HalfCheetahRandomParamsEnv',
    #max_episode_steps=1000,
    max_episode_steps=200,
    reward_threshold=4800.0,
)
...
register(
    id='HalfCheetah-Random-Params-discrete-v1',
    entry_point='gym.envs.mujoco:HalfCheetahRandomParamsDiscreteEnv',
    #max_episode_steps=1000,
    max_episode_steps=200,
    reward_threshold=4800.0,
)
...
register(
    id='Walker2d-Random-Params-v1',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:Walker2dRandomParamsEnv',
)

register(
    id='Walker2d-Random-Params-discrete-v1',
    max_episode_steps=1000,
    entry_point='gym.envs.mujoco:Walker2dRandomParamsDiscreteEnv',
)
...
register(
    id='Humanoid-Random-Params-v1',
    entry_point='gym.envs.mujoco:HumanoidRandomParamsEnv',
